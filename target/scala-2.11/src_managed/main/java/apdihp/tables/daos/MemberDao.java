...
public class MemberDao extends DAOImpl<MemberRecord, apdihp.tables.pojos.Member, Integer> {

    /**
     * Create a new MemberDao without any configuration
     */
    public MemberDao() {
        super(Member.MEMBER, apdihp.tables.pojos.Member.class);
    }
    ...
    public MemberDao(Configuration configuration) {
        super(Member.MEMBER, apdihp.tables.pojos.Member.class, configuration);
    }
     ...
     */
    @Override
    protected Integer getId(apdihp.tables.pojos.Member object) {
        return object.getId();
    }
     ...
     */
    public List<apdihp.tables.pojos.Member> fetchById(Integer... values) {
     ...
     */
    public apdihp.tables.pojos.Member fetchOneById(Integer value) {
     ...
     */
    public List<apdihp.tables.pojos.Member> fetchByTimestamp(Timestamp... values) {
     ...
     */
    public List<apdihp.tables.pojos.Member> fetchByName(String... values) {
     ...
     */
    public List<apdihp.tables.pojos.Member> fetchByUsername(String... values) {
     ...
     */
    public List<apdihp.tables.pojos.Member> fetchByStudentemail(String... values) {
     ...
     */
    public List<apdihp.tables.pojos.Member> fetchByPhonenumber(String... values) {
     ...
     */
    public List<apdihp.tables.pojos.Member> fetchByBirthdate(Timestamp... values) {
     ...
     */
    public List<apdihp.tables.pojos.Member> fetchByActivited(Integer... values) {
     ...
     */
    public List<apdihp.tables.pojos.Member> fetchByGender(String... values) {
     ...
     */
    public List<apdihp.tables.pojos.Member> fetchByPassword(String... values) {
     ...
     */
    public List<apdihp.tables.pojos.Member> fetchByCollegeid(Integer... values) {
     ...
     */
    public List<apdihp.tables.pojos.Member> fetchByBloodtype(String... values) {
     ...
     */
    public List<apdihp.tables.pojos.Member> fetchByEmergencynumber(String... values) {
     ...
     */
    public List<apdihp.tables.pojos.Member> fetchByBalance(Integer... values) {
     ...
     */
    public List<apdihp.tables.pojos.Member> fetchByStudentemailactivationcode(String... values) {
     ...
     */
    public List<apdihp.tables.pojos.Member> fetchByRideid(Integer... values) {
     ...
     */
    public List<apdihp.tables.pojos.Member> fetchByMembergroupid(Integer... values) {
     ...
     */
    public List<apdihp.tables.pojos.Member> fetchByLongitude(Double... values) {
     ...
     */
    public List<apdihp.tables.pojos.Member> fetchByLatitude(Double... values) {
     ...
     */
    public List<apdihp.tables.pojos.Member> fetchByPin(String... values) {
     ...
     */
    public List<apdihp.tables.pojos.Member> fetchByUniversityid(Integer... values) {
