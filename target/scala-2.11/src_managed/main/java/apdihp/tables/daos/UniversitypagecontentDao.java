...
public class UniversitypagecontentDao extends DAOImpl<UniversitypagecontentRecord, apdihp.tables.pojos.Universitypagecontent, Integer> {

    /**
     * Create a new UniversitypagecontentDao without any configuration
     */
    public UniversitypagecontentDao() {
        super(Universitypagecontent.UNIVERSITYPAGECONTENT, apdihp.tables.pojos.Universitypagecontent.class);
    }
    ...
    public UniversitypagecontentDao(Configuration configuration) {
        super(Universitypagecontent.UNIVERSITYPAGECONTENT, apdihp.tables.pojos.Universitypagecontent.class, configuration);
    }
     ...
     */
    @Override
    protected Integer getId(apdihp.tables.pojos.Universitypagecontent object) {
        return object.getId();
    }
     ...
     */
    public List<apdihp.tables.pojos.Universitypagecontent> fetchById(Integer... values) {
     ...
     */
    public apdihp.tables.pojos.Universitypagecontent fetchOneById(Integer value) {
     ...
     */
    public List<apdihp.tables.pojos.Universitypagecontent> fetchByTimestamp(Timestamp... values) {
     ...
     */
    public List<apdihp.tables.pojos.Universitypagecontent> fetchByTitle(String... values) {
     ...
     */
    public List<apdihp.tables.pojos.Universitypagecontent> fetchByBody(String... values) {
     ...
     */
    public List<apdihp.tables.pojos.Universitypagecontent> fetchByLink(String... values) {
     ...
     */
    public List<apdihp.tables.pojos.Universitypagecontent> fetchByDescription(String... values) {
     ...
     */
    public List<apdihp.tables.pojos.Universitypagecontent> fetchByKeywords(String... values) {
     ...
     */
    public List<apdihp.tables.pojos.Universitypagecontent> fetchByPic(String... values) {
