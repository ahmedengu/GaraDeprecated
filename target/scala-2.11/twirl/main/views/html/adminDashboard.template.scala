        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            ...
            <h2 class="sub-header">"""),_display_(/*135.37*/title),format.raw/*135.42*/("""
                """),format.raw/*136.17*/("""- <button type="button" class="btn btn-default" data-target="#modalnew" data-toggle="modal" onclick="newOnclic()">
                    New</button>
                |<a class="btn btn-default" href=""""),_display_(/*138.52*/routes/*138.58*/.Application.logout()),format.raw/*138.79*/("""">Logout</a>
            </h2>
            ...
            <div class="table-responsive">
                <table class="table table-striped">
                    <thead>
                        <tr>
                            """),_display_(/*145.30*/for(tData <- tableData) yield /*145.53*/ {_display_(Seq[Any](format.raw/*145.55*/("""
                                """),format.raw/*146.33*/("""<th>"""),_display_(/*146.38*/tData),format.raw/*146.43*/("""</th>
                            """)))}),format.raw/*147.30*/("""
                            """),format.raw/*148.29*/("""<th>edit</th>
                            <th>delete</th>
                        </tr>
                    </thead>
                    <tbody>
