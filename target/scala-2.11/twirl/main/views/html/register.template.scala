        ...
        """),format.raw/*26.9*/("""<div class="row">
            ...
            <div class="col-md-5">
                ...
                <form enctype="multipart/form-data" action="/register" method="post">
                    ...
                    <a href="http://www.g-ara.com/tos">Terms and Conditions</a>
